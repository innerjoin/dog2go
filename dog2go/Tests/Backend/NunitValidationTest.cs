...
namespace dog2go.Tests.Backend
{
    ...
    public class NunitValidationTest
    {
        ...
        public void dog_testPositiveMovedInSameFieldArea()
        {
            ...
            CardMove cardMove = new CardMove() {Card = new Card("card4", 4, new List<CardAttribute>() { new CardAttribute(AttributeEnum.FourFieldsBack), new CardAttribute(AttributeEnum.FourFields) }), SelectedAttribute = new CardAttribute(AttributeEnum.FourFields) };
