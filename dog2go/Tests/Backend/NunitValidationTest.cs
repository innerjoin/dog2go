...
namespace dog2go.Tests.Backend
{
    ...
    public class NunitValidationTest
    {
        ...
        public void dog_testLeaveKennel()
        {
            ...
            {
                Card = new Card("card11", 11, "mycard.png", new List<CardAttribute>() { new CardAttribute(AttributeEnum.ElevenFields), new CardAttribute(AttributeEnum.OneField), new CardAttribute(AttributeEnum.LeaveKennel) }),
        ...
        public void dog_testMovedInSameFieldAreaPositive()
        {
            ...
            CardMove cardMove = new CardMove()
            {
                Card = new Card("card4", 4, "mycard.png", new List<CardAttribute>() { new CardAttribute(AttributeEnum.FourFieldsBack), new CardAttribute(AttributeEnum.FourFields) }),
        ...
        public void dog_testMovedInOtherFieldAreaPositive()
        {
            ...
            CardMove cardMove = new CardMove()
            {
                Card = new Card("card13", 13, "mycard.png", new List<CardAttribute>() { new CardAttribute(AttributeEnum.ThirteenFields), new CardAttribute(AttributeEnum.LeaveKennel) }),
